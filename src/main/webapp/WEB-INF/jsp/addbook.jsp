...
<form class="layui-form layui-form-pane" action="<%=basePath%>admin/addbook" method="post"  enctype="multipart/form-data">
    <div class="layui-form-item">
        <label class="layui-form-label">图书名称</label>
        <div class="layui-input-block">
            <input name="bookname" class="layui-input" type="text" placeholder="请输入标题" autocomplete="off">
        </div>
    </div>
    ...
    <div class="layui-inline">
        ...
        <div class="layui-input-inline">
            <input name="press" class="layui-input" type="text" autocomplete="off">
        </div>
    </div>
    </div>
...
<br>
    ...
    <div class="layui-form-item" pane="">
        ...
        <div class="layui-input-block">
            <input name="booktype" title="国内文学" type="radio" checked="" value="1">
            <input name="booktype" title="外国文学" type="radio" value="2">
        </div>
    </div>
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea name="description" class="layui-textarea" placeholder="请输入30字以内的简介"></textarea>
            <%--<div class="layui-form-mid layui-word-aux">请输入30字以内的简介</div>--%>
        </div>
    </div>
    <div class="layui-form-item">
        <button class="layui-btn" type="submit" lay-filter="demo2" lay-submit="">提交</button>
    </div>
</form>
